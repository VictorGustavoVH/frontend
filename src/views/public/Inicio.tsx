    ...
    <div>
      ...
      <section className="py-12 px-4 md:px-8 bg-gray-100">
        <div className="max-w-5xl mx-auto">
          <h2 className={titleClasses}>¿Por qué una Ventana Inteligente?</h2>
          <p className={paragraphClasses}>
            Nuestra Ventana Inteligente te ayuda a mantener tu casa fresca, ahorrar energía
      ...
      <section className="py-12 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className={titleClasses}>Ventajas de Tener una Ventana Inteligente</h2>
      ...
      <section className="py-12 px-4 md:px-8 text-center bg-white">
        <div className="max-w-xl mx-auto">
          <h2 className={titleClasses}>¿Te interesa una Ventana Inteligente?</h2>
