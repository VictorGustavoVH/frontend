...
const UpdateProfile: React.FC = () => {
  ...
  // Al cargar el componente, obtenemos los datos del usuario para precargar el formulario
  useEffect(() => {
    async function fetchUser() {
      try {
        const { data } = await api.get('/user');
        // Pre-cargamos el formulario con los datos obtenidos
        reset(data);
      } catch (error) {
  ...
  const onSubmit = async (data: ProfileForm) => {
    ...
    try {
      ...
      // Puedes redirigir o actualizar el estado global según lo requieras
      navigate('/');
    } catch (error: any) {
      const msg =
            ...
            >
              ...
              <div>
                ...
                {errors.respuestaSecreta && (
                  <ErrorMessage>
                    {errors.respuestaSecreta.message}
                  </ErrorMessage>
                )}
              </div>
